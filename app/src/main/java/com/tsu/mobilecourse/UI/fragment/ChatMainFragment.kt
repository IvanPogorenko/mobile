...
import com.tsu.mobilecourse.databinding.FragmentChatMainBinding
...
class ChatMainFragment : Fragment() {
    ...
    interface OnFragmentInteractionListener {
        fun onFragmentClicked(name: String)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (args != null) {
            ...
            val blockDescription = args.getString("blocktext", "Описание")

            binding.img.setImageResource(blockImgResId)
            binding.name.text = blockName
            binding.text.text = blockDescription

            binding.root.setOnClickListener {
                listener?.onFragmentClicked(blockName)
